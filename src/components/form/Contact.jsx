...
function Contact() {
  const {theme,handleTheme} = useContext(ThemeContext);
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_c9ob5c8', 'template_v5y9972', form.current, {
            publicKey: '4xiDzFyPJx6Hy6TK2',
          })
          .then(
            () => {
              console.log('SUCCESS!');
  ...
  return (
    ...
    <div className="contact">
      <div className="container form-img d-flex justify-content-center align-items-center">
        <svg
        ...
        <form ref={form} onSubmit={sendEmail}>
          <h1 className={theme === "light" ? "title text-center mb-4" : "title text-white text-center mb-4"}>Talk to Us</h1>

          <div className="d-flex flex-column align-items-center justify-center gap-3">
